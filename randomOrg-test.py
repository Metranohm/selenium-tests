...
first_name2 = driver.find_element(By.CSS_SELECTOR, 'input[id="inputFirstName"]')
first_name2.send_keys("Halcyon")
last_name2 = driver.find_element(By.CSS_SELECTOR, 'input[id="inputFirstName"]')
...
input_state = driver.find_element(By.CSS_SELECTOR, 'input[id="stateinput"]')
time.sleep(3)
