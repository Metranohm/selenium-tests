...
input_city.send_keys("Belfast")
# county_click = driver.find_element(By.CSS_SELECTOR, 'input[placeholder="State"]')
# county_click()
# county_click.send_keys(Keys.RETURN)

# sel=Select(driver.find_element(By.CSS_SELECTOR, 'select[id="stateselect"]'))
# sel.select_by_visible_text('Doncaster')
input_postcode = driver.find_element(By.CSS_SELECTOR, 'input[id="inputPostcode"]')
input_postcode.send_keys('12345')
drop=Select(driver.find_element(By.CSS_SELECTOR, 'select[id="inputCountry"]'))
drop.select_by_visible_text('United Kingdom')
time.sleep(3)
